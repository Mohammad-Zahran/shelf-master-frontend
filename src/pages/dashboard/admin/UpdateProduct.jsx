  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        setValue("loadCapacity", product.loadCapacity);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      Swal.fire({
        icon: "error",
        title: "Update Failed",
        text: "There was an error while updating the product. Please try again.",
        confirmButtonText: "OK",
      });
    }
  };
  ...
  return (
    <div className="w-full md:w-[1250px] px-4 mx-auto">
      <h2 className="text-2xl font-semibold my-4">
        Update <span className="text-steelBlue">Product</span>
      </h2>
