...
const FloatingModel = () => {
    ...
    return (
      <>
        {/* Circle Background */}
        <mesh position={[0, -0.2, -2]} scale={3}> {/* Adjust the Y position upward */}
          <circleGeometry args={[2.5, 64]} />
          <meshStandardMaterial color="#C8E6FF" side={THREE.DoubleSide} /> {/* Grayish Steel Blue */}
        </mesh>
        ...
        <primitive
          ...
          position={[0, -2.5, 0]} // Lower the model's position
        />
      </>
    );
  };
